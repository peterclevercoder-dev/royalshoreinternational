# Generated by Django 5.2.6 on 2026-01-13 14:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_currency', models.CharField(choices=[('USD', 'US Dollar ($)'), ('NGN', 'Nigerian Naira (₦)'), ('EUR', 'Euro (€)'), ('GBP', 'British Pound (£)'), ('INR', 'Indian Rupee (₹)')], default='USD', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_name', models.CharField(default='Optima SCPB', max_length=200)),
                ...
                ('daily_transfer_limit', models.DecimalField(decimal_places=2, default=10000.0, max_digits=12)),
                ('minimum_balance', models.DecimalField(decimal_places=2, default=100.0, max_digits=12)),
